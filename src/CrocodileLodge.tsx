        ...
        <div className="footer-top">
          <div className="footer-brand">
            ...
            <div className="social-links">
              <a href="https://www.facebook.com/share/1CWQwy8KEX/" className="social-link" target="_blank" rel="noopener noreferrer" aria-label="Facebook">
              ...
              <a href="https://www.tiktok.com/@crocodilelodgediani?_r=1&_t=ZS-94XeUr1MiH7" className="social-link" target="_blank" rel="noopener noreferrer" aria-label="TikTok">
              ...
              <a href="https://wa.me/254715510119" className="social-link" target="_blank" rel="noopener noreferrer" aria-label="WhatsApp">
              ...
              <a href="mailto:crocodilelodgediani@gmail.com" className="social-link" aria-label="Email">
          ...
          <div className="footer-col">
            ...
            <div className="footer-contact-item">
              <span className="contact-icon">📞</span>
              <a href="https://wa.me/254715510119" target="_blank" rel="noopener noreferrer" style={{ color: "inherit", textDecoration: "none" }}>
                <span className="contact-text">+254 715 510 119</span>
              </a>
            </div>
            <div className="footer-contact-item">
              <span className="contact-icon">📧</span>
              <a href="mailto:crocodilelodgediani@gmail.com" style={{ color: "inherit", textDecoration: "none" }}>
                <span className="contact-text">crocodilelodgediani@gmail.com</span>
              </a>
            </div>
            <div className="footer-contact-item">
              <span className="contact-icon">⏰</span>
